...
#makehelp='make CROSS_COMPILE=/home/user/x-tools/arm-hsth-linux-gnueabi/bin/arm-hsth-linux-gnueabi- ARCH=arm LOCALVERSION='
makehelp='make CROSS_COMPILE=/usr/bin/arm-linux-gnueabi- ARCH=arm'
